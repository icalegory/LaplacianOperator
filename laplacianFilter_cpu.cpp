/*
 * This is the original Box Filter CPU code.  I leave it here in case I decide to merge
 * my Laplacian CPU code (from the OpenGLDisplayImage Visual Studio 2015 Solution) into
 * this program.
 *
